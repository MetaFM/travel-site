...
var RevealOnScroll = function () {
  function RevealOnScroll(itemToReveal, itemOffset) {
  ...
  _createClass(RevealOnScroll, [{
    ...
    key: 'createWaypoints',
    value: function createWaypoints(itemOffset) {
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.headerLinks = (0, _jquery2.default)('.primary-nav ul li a');
    ...
    value: function createHeaderWaypoint() {
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          if (direction == 'down') that.siteHeader.addClass('site-header--dark');else {
